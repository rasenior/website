...
![](/post/2019-10-21/hexsticker.png)
...
```{r fig-1, fig.cap= "The output of `plot_patches` includes a histogram and the original temperature data overlaid with outlines of hot and cold spots, identified using the G* variant of the Getis-Ord local statistic.", echo = FALSE, include = FALSE}
plot_patches(
